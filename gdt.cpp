...
GlobalDiscriptorTable::SegmentDescriptor::SegmentDescriptor(uint32_t base,uint32_t limit,uint8_t flags){
...
uint32_t GlobalDiscriptorTable::SegmentDescriptor::Base()
{
    uint8_t* target = (uint8_t*)this;
...
uint32_t GlobalDiscriptorTable::SegmentDescriptor::Limit()
{
 uint8_t* target = (uint8_t*)this;
    uint32_t result = target[6]&0xF;
    result = (result<<8) +target[1];
     result = (result<<8) +target[0];
     if((target[6]&0xC0)==0xC0) result = (result<<22)|0xFFF;
      return result;
}